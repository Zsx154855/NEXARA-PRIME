...
TRANSITIONS: dict[MissionState, set[MissionState]] = {
    ...
    MissionState.VERIFICATION: {MissionState.EXECUTION, MissionState.EVIDENCE, MissionState.BLOCKED, MissionState.FAILED, MissionState.ROLLED_BACK},
    MissionState.EVIDENCE: {MissionState.EXECUTION, MissionState.MEMORY_PATCH, MissionState.BLOCKED, MissionState.FAILED},
    MissionState.MEMORY_PATCH: {MissionState.EXECUTION, MissionState.EVALUATION, MissionState.BLOCKED, MissionState.FAILED},
    MissionState.EVALUATION: {MissionState.EXECUTION, MissionState.COMPLETED, MissionState.BLOCKED, MissionState.FAILED, MissionState.ROLLED_BACK},
