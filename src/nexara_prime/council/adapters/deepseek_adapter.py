"""NEXARA Council V2 — DeepSeek Adapter (H-STAFF, H-MEM)

Direct API adapter for DeepSeek models (OpenAI-compatible API).
Uses httpx. Credentials from Keychain.
"""
...
class DeepSeekAdapter(BaseAdapter):
    """Direct DeepSeek API adapter."""

    API_BASE = "https://api.deepseek.com/v1"

    def __init__(self, seat: str = "H-STAFF"):
        super().__init__(
